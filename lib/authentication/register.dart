...
//     FirebaseFirestore.instance.collection("riders").doc(currentUser.uid).get({
      ...
      child: Column(
        ...
        children: [
            ...
            child: CircleAvatar(
              ...
              child: imageXFile == null
                  ? Icon(
                      Icons.add_photo_alternate,
                      size: MediaQuery.of(context).size.width * 0.20,
                      color: const Color.fromARGB(202, 14, 206, 46),
                    )
                  : null,
            ),
          ),
          ...
          ElevatedButton(
            ...
            style: ElevatedButton.styleFrom(
              // ignore: deprecated_member_use
              primary: const Color.fromARGB(202, 14, 206, 46),
              padding: const EdgeInsets.symmetric(horizontal: 50, vertical: 10),
            ),
            onPressed: () {
              formValidation();
